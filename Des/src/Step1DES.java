...
public class Step1DES {
	...
	public String[] getNewShiftedKeys() {
		return newShiftedKeys;
	}

	public int[] PC1 = { 57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 27, 19, 11, 3, 60,
	...
	public int[] shiftBits = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };
	...
	public String[] GetAllNewKeys() {
		String Kplus = GetKeyPlus();
		SplitLeftRight(Kplus);
		GetShiftedKeys();
		GetPermutionKeys();
		return this.GetAllNewKeys();
	}
